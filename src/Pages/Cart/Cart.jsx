          ...
          <div>
            ...
            <div className="my-6 flex flex-col gap-2 items-center justify-center">
              <div className='flex items-center gap-8'>
                ...
                <s className='text-sm text-gray-400'>{Number(productsStore.reduce((acc, curr) => acc + curr.price * curr.quantity, 0)).toLocaleString()} تومان</s>
              </div>
              <div className='flex items-center gap-8'>
              ...
              <div className='flex items-center gap-8'>
                <div>سود شما: </div>
                <div className='text-sm text-gray-400'>{((productsStore.reduce((acc, curr) => acc + curr.price * curr.quantity, 0)) - (productsStore.reduce((acc, curr) => acc + (curr.discount ? (curr.price * ((100 - curr.discount) / 100)) : curr.price) * curr.quantity, 0))).toLocaleString()} تومان</div>
              </div>
              <div>
